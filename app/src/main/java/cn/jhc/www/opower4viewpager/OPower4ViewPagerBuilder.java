...
public class OPower4ViewPagerBuilder extends RelativeLayout {
    ...
    public OPower4ViewPagerBuilder show()
    {
        this.addView(mSelf);
        return this;
    }

    public OPower4ViewPagerBuilder needIndicateDots(Boolean b, @Nullable int...w_h_leftMargin)
    {
        if (b)
        {
            //init the dots
     ...
     * @return
     */
    public OPower4ViewPagerBuilder needBottomNavibar(Boolean b, @Nullable RadioGroup radioGroup, @Nullable int[] item_ids)
    {
     ...
     * @return
     */
    public OPower4ViewPagerBuilder setDataSrc(Context context, List<View> layoutViews)
    {
        mContext = context;
        initView();
    ...
    public OPower4ViewPagerBuilder setDataSrc(Context context, final int[] resIds)
    {
        mContext = context;
    ...
    public OPower4ViewPagerBuilder setDataSrc(Context context, String[] urls)
    {
        mContext = context;
